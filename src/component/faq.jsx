                    ...
                    <div class="md:max-w-4xl mx-auto">
                        ...
                        <div class="mb-11 flex flex-wrap -m-1">
                            <div className="w-full p-1">
                                ...
                                {faqID == 0 && (<div className="py-7 px-8 bg-white bg-opacity-60 border-2 border-[#5555bd] rounded-2xl shadow-10xl">
                                ...
                                {faqID != 0 && (<div class="py-7 px-8 bg-white bg-opacity-60 border border-gray-200 hover:border-gray-300 rounded-2xl shadow-10xl">
                                    <div class="flex flex-wrap justify-between -m-2">
                                        <div class="flex-1 p-2">
                                ...
                                {/* <div className="py-7 px-8 bg-white bg-opacity-60 border-2 border-[#5555bd] rounded-2xl shadow-10xl">
                                    <div class="flex flex-wrap justify-between -m-2">
                                        <div class="flex-1 p-2">
                                            <h3 class="mb-4 text-lg font-semibold leading-normal">Do you provide any free plan?</h3>
                                            <p class="text-gray-600 font-medium">Lorem ipsum dolor sit amet, to the consectr adipiscing elit. Volutpat tempor to the condi mentum vitae vel purus.</p>
